...
func CalibreID(v int64) predicate.Tag {
	return predicate.Tag(sql.FieldEQ(FieldCalibreID, v))
}
...
func CalibreIDEQ(v int64) predicate.Tag {
	return predicate.Tag(sql.FieldEQ(FieldCalibreID, v))
}

// CalibreIDNEQ applies the NEQ predicate on the "calibre_id" field.
func CalibreIDNEQ(v int64) predicate.Tag {
	return predicate.Tag(sql.FieldNEQ(FieldCalibreID, v))
}

// CalibreIDIn applies the In predicate on the "calibre_id" field.
func CalibreIDIn(vs ...int64) predicate.Tag {
	return predicate.Tag(sql.FieldIn(FieldCalibreID, vs...))
}

// CalibreIDNotIn applies the NotIn predicate on the "calibre_id" field.
func CalibreIDNotIn(vs ...int64) predicate.Tag {
	return predicate.Tag(sql.FieldNotIn(FieldCalibreID, vs...))
}

// CalibreIDGT applies the GT predicate on the "calibre_id" field.
func CalibreIDGT(v int64) predicate.Tag {
	return predicate.Tag(sql.FieldGT(FieldCalibreID, v))
}

// CalibreIDGTE applies the GTE predicate on the "calibre_id" field.
func CalibreIDGTE(v int64) predicate.Tag {
	return predicate.Tag(sql.FieldGTE(FieldCalibreID, v))
}

// CalibreIDLT applies the LT predicate on the "calibre_id" field.
func CalibreIDLT(v int64) predicate.Tag {
	return predicate.Tag(sql.FieldLT(FieldCalibreID, v))
}

// CalibreIDLTE applies the LTE predicate on the "calibre_id" field.
func CalibreIDLTE(v int64) predicate.Tag {
