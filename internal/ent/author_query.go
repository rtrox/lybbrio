...
func (aq *AuthorQuery) FirstID(ctx context.Context) (id ksuid.ID, err error) {
	var ids []ksuid.ID
...
func (aq *AuthorQuery) FirstIDX(ctx context.Context) ksuid.ID {
...
func (aq *AuthorQuery) OnlyID(ctx context.Context) (id ksuid.ID, err error) {
	var ids []ksuid.ID
...
func (aq *AuthorQuery) OnlyIDX(ctx context.Context) ksuid.ID {
...
func (aq *AuthorQuery) IDs(ctx context.Context) (ids []ksuid.ID, err error) {
...
func (aq *AuthorQuery) IDsX(ctx context.Context) []ksuid.ID {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AuthorQuery) loadBooks(ctx context.Context, query *BookQuery, nodes []*Author, init func(*Author), assign func(*Author, *Book)) error {
	...
	byID := make(map[ksuid.ID]*Author)
	nids := make(map[ksuid.ID]map[*Author]struct{})
