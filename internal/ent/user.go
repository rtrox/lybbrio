...
func (e UserEdges) ShelvesOrErr() ([]*Shelf, error) {
	if e.loadedTypes[0] {
...
// NamedShelves returns the Shelves named value or an error if the edge was not
// loaded in eager-loading with this name.
func (u *User) NamedShelves(name string) ([]*Shelf, error) {
	if u.Edges.namedShelves == nil {
		return nil, &NotLoadedError{edge: name}
	}
	nodes, ok := u.Edges.namedShelves[name]
	if !ok {
		return nil, &NotLoadedError{edge: name}
	}
	return nodes, nil
...
func (u *User) appendNamedShelves(name string, edges ...*Shelf) {
	if u.Edges.namedShelves == nil {
		u.Edges.namedShelves = make(map[string][]*Shelf)
	}
	if len(edges) == 0 {
		u.Edges.namedShelves[name] = []*Shelf{}
	} else {
		u.Edges.namedShelves[name] = append(u.Edges.namedShelves[name], edges...)
	}
}
