...
func (tq *TaskQuery) FirstID(ctx context.Context) (id ksuid.ID, err error) {
	var ids []ksuid.ID
...
func (tq *TaskQuery) FirstIDX(ctx context.Context) ksuid.ID {
...
func (tq *TaskQuery) OnlyID(ctx context.Context) (id ksuid.ID, err error) {
	var ids []ksuid.ID
...
func (tq *TaskQuery) OnlyIDX(ctx context.Context) ksuid.ID {
...
func (tq *TaskQuery) IDs(ctx context.Context) (ids []ksuid.ID, err error) {
...
func (tq *TaskQuery) IDsX(ctx context.Context) []ksuid.ID {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
