...
func (uq *UserQuery) QueryShelves() *ShelfQuery {
	query := (&ShelfClient{config: uq.config}).Query()
...
func (uq *UserQuery) FirstID(ctx context.Context) (id ksuid.ID, err error) {
	var ids []ksuid.ID
...
func (uq *UserQuery) FirstIDX(ctx context.Context) ksuid.ID {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id ksuid.ID, err error) {
	var ids []ksuid.ID
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) ksuid.ID {
...
func (uq *UserQuery) IDs(ctx context.Context) (ids []ksuid.ID, err error) {
...
func (uq *UserQuery) IDsX(ctx context.Context) []ksuid.ID {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (uq *UserQuery) WithShelves(opts ...func(*ShelfQuery)) *UserQuery {
	query := (&ShelfClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withShelves; query != nil {
	...
	for name, query := range uq.withNamedShelves {
		if err := uq.loadShelves(ctx, query, nodes,
			func(n *User) { n.appendNamedShelves(name) },
			func(n *User, e *Shelf) { n.appendNamedShelves(name, e) }); err != nil {
			return nil, err
		}
	}
...
func (uq *UserQuery) loadShelves(ctx context.Context, query *ShelfQuery, nodes []*User, init func(*User), assign func(*User, *Shelf)) error {
...
// WithNamedShelves tells the query-builder to eager-load the nodes that are connected to the "shelves"
// edge with the given name. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithNamedShelves(name string, opts ...func(*ShelfQuery)) *UserQuery {
	query := (&ShelfClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if uq.withNamedShelves == nil {
		uq.withNamedShelves = make(map[string]*ShelfQuery)
	}
	uq.withNamedShelves[name] = query
	return uq
}
